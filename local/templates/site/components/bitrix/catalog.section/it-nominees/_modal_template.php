            ...
            <div class="_items js-more-items">
               ...
               <div class="_item_wrapper">
                  <div class="_item">
                     ...
                     <div class="_footer">
                       <a class="it-href it-href-more-o" data-modal-target="#nomines-<?=$arElement['ID']?>" href="">Подробнее</a>
                     </div>
               ...
               <div  id="nomines-<?=$arElement['ID']?>" class="it-modal">
                  <div class="it-modal-close js-close" onclick="Custombox.modal.close();"><img src="/assets/images/modal-close.svg"></div>                  
